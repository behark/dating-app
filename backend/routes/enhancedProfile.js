...
router.put('/prompts/update', authenticate, [
...
], handleValidationErrors, updatePrompts);
...
], handleValidationErrors, updateEducation);

// Update occupation
router.put('/occupation', authenticate, [
  body('jobTitle').optional().trim(),
  body('company').optional().trim(),
  body('industry').optional().trim()
], handleValidationErrors, updateOccupation);

// Update height
router.put('/height', authenticate, [
...
], handleValidationErrors, updateHeight);

// Update ethnicity
router.put('/ethnicity', authenticate, [
  body('ethnicity').isArray().withMessage('Ethnicity must be an array')
], handleValidationErrors, updateEthnicity);
