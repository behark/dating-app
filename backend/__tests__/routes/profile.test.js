...
describe('Profile API Tests', () => {
  ...
  describe('GET /api/profile/me', () => {
    ...
    describe('Unauthorized Access', () => {
      ...
      it('should reject request with expired token', async () => {
        ...
        const expiredToken = jwt.sign({ userId: 'user_id' }, process.env.JWT_SECRET, {
          expiresIn: -1,
        });
  ...
  describe('GET /api/profile/:userId', () => {
    ...
    describe('Unauthorized Access', () => {
      ...
      it('should reject request without authentication', async () => {
        const response = await request(app).get('/api/profile/some_user_id');
  ...
  describe('DELETE /api/profile/photos/:photoId', () => {
    ...
    describe('Unauthorized Access', () => {
      it('should reject unauthenticated request', async () => {
        const response = await request(app).delete('/api/profile/photos/photo_123');
