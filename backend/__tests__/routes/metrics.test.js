    ...
    describe('Success Cases', () => {
      it('should return user engagement metrics', async () => {
        User.findById.mockResolvedValue({
          _id: 'user_id',
          lastActive: new Date(),
          sessions: [{ startTime: new Date(), duration: 1200 }],
        });
  ...
  describe('GET /api/metrics/profile', () => {
    describe('Success Cases', () => {
      it('should return profile performance metrics', async () => {
        ...
        Swipe.aggregate.mockResolvedValue([{ _id: null, rightSwipes: 80, totalSwipes: 200 }]);
  ...
  describe('Admin Metrics', () => {
    ...
    describe('GET /api/metrics/admin/matches', () => {
      it('should return matching statistics', async () => {
        ...
        Match.aggregate.mockResolvedValue([{ _id: 'daily', count: 200, avgTime: 3600 }]);
