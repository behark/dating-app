...
export const AuthProvider = ({ children }) => {
  ...
  const verifyEmail = async (token) => {
    try {
      ...
      const data = await response.json();
      if (!response.ok) {
        throw new Error(getUserFriendlyMessage(data.message || 'Email verification failed'));
      }
      return data;
    } catch (error) {
  ...
  const sendPhoneVerification = async (phoneNumber) => {
    try {
      ...
      const data = await response.json();
      if (!response.ok) {
        throw new Error(getUserFriendlyMessage(data.message || 'Failed to send verification code'));
      }
      return data;
    } catch (error) {
  ...
  const verifyPhone = async (code) => {
    try {
      ...
      const data = await response.json();
      if (!response.ok) {
        throw new Error(getUserFriendlyMessage(data.message || 'Phone verification failed'));
      }
      return data;
    } catch (error) {
  ...
  const forgotPassword = async (email) => {
    try {
      ...
      const data = await response.json();
      if (!response.ok) {
        throw new Error(getUserFriendlyMessage(data.message || 'Failed to send reset email'));
      }
      return data;
    } catch (error) {
  ...
  const resetPassword = async (token, newPassword) => {
    try {
      ...
      const data = await response.json();
      if (!response.ok) {
        throw new Error(getUserFriendlyMessage(data.message || 'Password reset failed'));
      }
      return data;
    } catch (error) {
  ...
  const deleteAccount = async (password) => {
    try {
      ...
      const data = await response.json();
      if (!response.ok) {
        throw new Error(getUserFriendlyMessage(data.message || 'Failed to delete account'));
      }
