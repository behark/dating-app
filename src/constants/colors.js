...
export const Colors = {
  ...
  status: {
    ...
    warningDark: '#E65100',
    warningOrange: Colors.status.warningOrange,
    info: '#2196F3',
    infoLight: Colors.status.infoLight,
    infoDark: '#0D47A1',
    infoBlue: Colors.status.infoBlue,
  },
  ...
  gamification: {
    ...
    level6: '#FFD700',
    level7: '#8B5CF6',
    level8: Colors.status.warningOrange,
    level9: '#EF4444',
    level10: '#EC4899',
    newcomer: '#78909C',
    explorer: '#4CAF50',
    connector: '#2196F3',
    socialButterfly: Colors.gamification.socialButterfly,
    charmer: '#FF9800',
    heartbreaker: '#E91E63',
    loveExpert: '#F44336',
    matchmaker: '#E040FB',
