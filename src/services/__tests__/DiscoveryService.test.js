...
describe('DiscoveryService', () => {
  ...
  const mockProfiles = [
    {
      ...
      name: 'Alice',
      age: 27,
      location: { latitude: 40.7300, longitude: -74.0100 },
      photos: ['photo1.jpg'],
      bio: 'Love hiking',
    },
    {
      ...
      name: 'Emma',
      age: 29,
      location: { latitude: 40.7500, longitude: -73.9900 },
      photos: ['photo2.jpg'],
  ...
  describe('filterByAge', () => {
    it('should filter profiles within age range', () => {
      const profiles = DiscoveryService.filterByAge(
        mockProfiles,
        { min: 25, max: 28 }
      );
  ...
  describe('sortByCompatibility', () => {
    it('should sort profiles by compatibility score', async () => {
      const sortedProfiles = await DiscoveryService.sortByCompatibility(
        mockProfiles,
        mockUser
      );
